...
# This is to make a new directory for the plots:
plot_dir = "plots"
...
for column in continuous_attributes:
    ...
    plt.savefig(os.path.join(plot_dir, f"Histogram with Boxplot for {column}.png"))
    plt.show()
...
for column in categorical_attributes:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(plot_dir, f"Histogram for {column}.png"))
    plt.show()
...
for column in continuous_attributes:
    ...
    plt.savefig(os.path.join(plot_dir, f"Q-Q Plot for {column}.png"))
    plt.show()
"""
Notes:
...
plt.savefig(os.path.join(plot_dir, "Correlation Heatmap.png"))
plt.show()
...
plt.grid(True)
plt.savefig(os.path.join(plot_dir, "Cumlative Explained Variance as Number of Components Increases.png"))
plt.show()
...
plt.grid(True)
plt.savefig(os.path.join(plot_dir, "Explained Inertia as Number of Components Increases.png"))
plt.show()
...
# Display
plt.savefig(os.path.join(plot_dir, "MCA Scatter Plot for Individuals.png"))
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(plot_dir, "Explained Variance as Number of Components Increases.png"))
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(plot_dir, "Cumulative Explained Variance as Number of Components Increases.png"))
plt.show()
...
plt.savefig(os.path.join(plot_dir, "3D Scatter plot of the the PCs for continous data.png"))
plt.show()
